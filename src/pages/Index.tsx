  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-purple-500/30 to-pink-500/30 rounded-full blur-3xl animate-blob"></div>
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-br from-blue-500/30 to-purple-500/30 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-pink-500/20 to-cyan-500/20 rounded-full blur-3xl animate-blob animation-delay-4000"></div>
      </div>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass-effect border-b border-white/10 backdrop-blur-xl">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="text-2xl font-bold font-space bg-gradient-to-r from-purple-400 via-pink-500 to-cyan-400 bg-clip-text text-transparent animate-pulse">
              Muhammad Aziz
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Button
                ...
                className="hover:bg-white/10 hover:scale-110 transition-all duration-300 hover:rotate-180"
              >
          ...
          {/* Mobile Menu */}
          {isMenuOpen && (
            <div className="md:hidden mt-4 pb-4 space-y-2 animate-slide-in-right backdrop-blur-xl bg-black/20 rounded-lg p-4">
              <button onClick={() => scrollToSection('home')} className="block w-full text-left py-2 hover:text-purple-400 transition-colors hover:translate-x-2">Home</button>
              <button onClick={() => scrollToSection('about')} className="block w-full text-left py-2 hover:text-purple-400 transition-colors hover:translate-x-2">About</button>
              <button onClick={() => scrollToSection('projects')} className="block w-full text-left py-2 hover:text-purple-400 transition-colors hover:translate-x-2">Projects</button>
              <button onClick={() => scrollToSection('contact')} className="block w-full text-left py-2 hover:text-purple-400 transition-colors hover:translate-x-2">Contact</button>
            </div>
          )}
        </div>
      </nav>
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
        <div className="container mx-auto px-6 text-center">
          <div className={`transition-all duration-2000 ${isLoaded ? 'animate-fade-in' : 'opacity-0 translate-y-20'}`}>
            <div className="mb-12 relative">
              <div className="relative inline-block">
                ...
                <img
                  ...
                  alt="Muhammad Aziz"
                  className="relative w-64 h-64 md:w-80 md:h-80 rounded-full mx-auto border-4 border-gradient-to-r from-purple-500 to-pink-500 shadow-2xl hover:scale-105 transition-all duration-500 hover:rotate-3"
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg max-w-2xl mx-auto mb-12 animate-fade-in animation-delay-1000 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center animate-scale-in animation-delay-1500">
                <Button 
                  size="lg" 
                  className="group bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-medium px-12 py-6 text-lg hover-glow transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:shadow-purple-500/50"
                ...
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-2 border-purple-500 text-purple-400 hover:bg-purple-500 hover:text-white px-12 py-6 text-lg transition-all duration-500 hover:scale-110 hover:shadow-xl backdrop-blur-sm"
      ...
      {/* About Section */}
      <section id="about" className="py-32 bg-gradient-to-b from-transparent to-purple-900/10 relative">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-7xl font-bold font-space mb-8 animate-fade-in">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            <div className="animate-slide-in-left space-y-8">
              <h3 className="text-3xl font-bold mb-8 font-space flex items-center">
            ...
            <div className="animate-slide-in-right">
              <div className="relative">
                ...
                <Card className="relative bg-black/40 backdrop-blur-xl border-purple-500/30 hover:border-purple-400/60 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
                  <CardContent className="p-8">
                    ...
                    <div className="space-y-4 text-muted-foreground">
                      <div className="flex items-start space-x-3">
                        ...
                        <p>Innovative content that makes learning engaging and memorable</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <Globe className="h-5 w-5 text-blue-400 mt-1 flex-shrink-0" />
                        <p>Building global communities of passionate English learners</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <Play className="h-5 w-5 text-green-400 mt-1 flex-shrink-0" />
                        <p>Using multimedia and interactive methods for better retention</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <Zap className="h-5 w-5 text-purple-400 mt-1 flex-shrink-0" />
                        <p>Proven track record of helping students achieve fluency</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-32 bg-gradient-to-b from-transparent to-purple-900/20 relative">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-7xl font-bold font-space mb-8 animate-fade-in">
          ...
          <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto">
            <div className="animate-slide-in-left space-y-8">
              <h3 className="text-3xl font-bold mb-8 font-space flex items-center">
                <MessageCircle className="mr-3 h-8 w-8 text-purple-400" />
                Get In Touch
              </h3>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4 group hover:translate-x-2 transition-transform duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground group-hover:text-pink-400 transition-colors">
                      @uktamov
                    </p>
                  </div>
                </div>
              ...
              <div className="pt-6">
                <h4 className="text-xl font-bold mb-4 text-purple-400">My Channels</h4>
                <div className="grid grid-cols-2 gap-4">
                  {projects.map((project, index) => (
                    <Button 
                      ...
                      variant="outline" 
                      size="sm"
                      className="border-purple-500/30 text-purple-400 hover:bg-purple-500 hover:text-white transition-all duration-300 hover:scale-105"
                      asChild
                    >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="relative group">
                        <Input
                          ...
                          className="bg-black/20 border-purple-500/30 focus:border-purple-400 transition-all duration-300 pl-4 pt-6 pb-2 group-hover:shadow-lg group-hover:shadow-purple-500/20"
                          required
                        />
                      ...
                      <div className="relative group">
                        <Textarea
                          ...
                          rows={4}
                          className="bg-black/20 border-purple-500/30 focus:border-purple-400 transition-all duration-300 pl-4 pt-6 pb-2 resize-none group-hover:shadow-lg group-hover:shadow-purple-500/20"
                          required
                        />
                        <label className="absolute left-4 top-2 text-xs text-purple-400 transition-all duration-300">
                          Message
                      ...
                      <Button
                        type="submit"
                        className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-medium py-4 text-lg hover-glow transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/50"
                      >
      ...
      {/* Footer */}
      <footer className="py-16 border-t border-purple-500/20 bg-gradient-to-t from-purple-900/20 to-transparent">
        <div className="container mx-auto px-6">
          <div className="text-center space-y-8">
            <div className="flex justify-center space-x-6">
              <Button
                variant="ghost"
                size="icon"
                className="hover:bg-purple-500/20 hover:scale-110 transition-all duration-300 hover:rotate-12"
                asChild
              >
              ...
              <Button
                variant="ghost"
                size="icon"
                className="hover:bg-pink-500/20 hover:scale-110 transition-all duration-300 hover:rotate-12"
                asChild
              >
        ...
        <Button
          ...
          className="fixed bottom-8 right-8 p-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 hover:shadow-purple-500/50 z-40"
          size="icon"
        >
          <Rocket className="h-6 w-6 text-white hover:animate-bounce" />
        </Button>
      </footer>
    </div>
  );
